...
export const GetStartedTutorial = () => {
  const [hideTutorial, setShowTutorial] = useState(
    globalThis.localStorage.getItem("getstarted_closedTutorial") !== null,
  );
  ...
  const onClose = () => {
    globalThis.localStorage.setItem("getstarted_closedTutorial", "true");
      ...
      >
        ...
        <Stack space={5}>
          ...
          <Container width={1}>
            ...
            >
              Next, our docs will guide you through building schema types,
              adding content, and connecting a frontend. You’ll see updates
              reflected in your Studio below.
            </TextContainer>
          </Container>
